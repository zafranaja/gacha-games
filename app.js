...
const animals = [
  ...
  // Tambahan 50 hewan baru
  { id: 'tikus_hutan', name: 'Tikus Hutan', emoji: '🐀', rarity: 'biasa', desc: 'Lincah dan cepat, sering bersembunyi di akar pohon besar.', height: '10 cm', weight: '0.15 kg' },
  { id: 'musang_belukar', name: 'Musang Belukar', emoji: '🦝', rarity: 'biasa', desc: 'Cerdik dan suka menjelajah semak-semak pada senja hari.', height: '35 cm', weight: '2 kg' },
  { id: 'babi_hutan', name: 'Babi Hutan', emoji: '🐗', rarity: 'biasa', desc: 'Berkeliaran dalam kelompok kecil dan sangat berani saat terancam.', height: '80 cm', weight: '40 kg' },
  { id: 'landak', name: 'Landak', emoji: '🦔', rarity: 'biasa', desc: 'Bertahan dengan duri tajam dan bergerak pelan saat mencari makan.', height: '25 cm', weight: '1.2 kg' },
  { id: 'trenggiling', name: 'Trenggiling', emoji: '🐾', rarity: 'biasa', desc: 'Pemakan semut yang bergerak tenang di malam hari.', height: '60 cm', weight: '7 kg' },
  { id: 'rakun', name: 'Rakun', emoji: '🦝', rarity: 'biasa', desc: 'Sangat suka menjelajah dan memegang barang-barang kecil dengan cerdik.', height: '45 cm', weight: '6 kg' },
  { id: 'tarsius', name: 'Tarsius', emoji: '🐒', rarity: 'biasa', desc: 'Primata kecil yang aktif di malam hari dengan mata besar.', height: '15 cm', weight: '0.1 kg' },
  { id: 'binturong', name: 'Binturong', emoji: '🐾', rarity: 'biasa', desc: 'Memiliki ekor panjang yang membantu menjaga keseimbangan di pepohonan.', height: '65 cm', weight: '9 kg' },
  { id: 'marmot', name: 'Marmot', emoji: '🐹', rarity: 'biasa', desc: 'Menghabiskan banyak waktu di sarang dan memperingatkan kawanan saat bahaya datang.', height: '20 cm', weight: '0.8 kg' },
  { id: 'kijang', name: 'Kijang', emoji: '🦌', rarity: 'biasa', desc: 'Lincah berlari di padang rumput dan sangat waspada terhadap ancaman.', height: '90 cm', weight: '50 kg' },
  { id: 'beruang_madu', name: 'Beruang Madu', emoji: '🐻', rarity: 'langka', desc: 'Berukuran kecil namun sangat kuat saat berburu madu dan buah.', height: '1.2 m', weight: '50 kg' },
  { id: 'gajah_hutan', name: 'Gajah Hutan', emoji: '🐘', rarity: 'langka', desc: 'Membentuk jalur besar di hutan dan menjaga ekosistem sekitar.', height: '2.2 m', weight: '3 ton' },
  { id: 'kucing_raut', name: 'Kucing Raut', emoji: '🐈', rarity: 'langka', desc: 'Memiliki ekor bulu panjang dan gerakan sangat halus saat menyelinap.', height: '40 cm', weight: '4 kg' },
  { id: 'kijang_belukar', name: 'Kijang Belukar', emoji: '🦌', rarity: 'langka', desc: 'Berlari cepat di sela semak dan memanfaatkan warna tubuh untuk berkamuflase.', height: '70 cm', weight: '30 kg' },
  { id: 'pangolin', name: 'Pangolin', emoji: '🦥', rarity: 'langka', desc: 'Hewan unik yang melindungi diri dengan sisik keras seperti armor.', height: '50 cm', weight: '8 kg' },
  { id: 'wolverine', name: 'Wolverine', emoji: '🐾', rarity: 'langka', desc: 'Kuat dan agresif, sering menguasai wilayahnya dengan gigih.', height: '65 cm', weight: '15 kg' },
  { id: 'lynx', name: 'Lynx', emoji: '🐱', rarity: 'langka', desc: 'Pemangsa halus dengan kaki besar dan cakar tajam.', height: '70 cm', weight: '20 kg' },
  { id: 'hyena', name: 'Hyena', emoji: '🐺', rarity: 'langka', desc: 'Cerdas dan penuh strategi, sering bekerja sama untuk mencari mangsa.', height: '80 cm', weight: '60 kg' },
  { id: 'moose', name: 'Moose', emoji: '🦌', rarity: 'langka', desc: 'Hewan besar dengan tanduk lebar yang menjadikannya simbol hutan utara.', height: '2.1 m', weight: '500 kg' },
  { id: 'eland_hutan', name: 'Eland Hutan', emoji: '🦬', rarity: 'langka', desc: 'Berjalan tenang dengan langkah tegap di wilayah rawa dan semak.', height: '1.8 m', weight: '700 kg' },
  { id: 'rusa_silva', name: 'Rusa Silva', emoji: '🦌', rarity: 'legendaris', desc: 'Makhluk hutan yang memancarkan cahaya lembut saat bergerak di malam.', height: '1.3 m', weight: '140 kg' },
  { id: 'naga_bambu', name: 'Naga Bambu', emoji: '🐉', rarity: 'legendaris', desc: 'Naga kecil yang berdiam di belantara bambu dan menjaga keseimbangan alam.', height: '4 m', weight: '220 kg' },
  { id: 'faun_akar', name: 'Faun Akar', emoji: '🦌', rarity: 'legendaris', desc: 'Makhluk setengah manusia yang mengawasi rerimbunan akar tua.', height: '1.7 m', weight: '180 kg' },
  { id: 'sylvan_wolf', name: 'Sylvan Wolf', emoji: '🐺', rarity: 'legendaris', desc: 'Serigala penjaga hutan dengan mata menyala di bawah sinar bulan.', height: '1.1 m', weight: '80 kg' },
  { id: 'raksasa_pohon', name: 'Raksasa Pohon', emoji: '🌳', rarity: 'legendaris', desc: 'Makhluk purba yang tumbuh dari batang pohon tertua di hutan.', height: '8 m', weight: '1.2 ton' },
  { id: 'kucing_malam', name: 'Kucing Malam', emoji: '🐈', rarity: 'legendaris', desc: 'Hewan mistis yang melintas tanpa suara di antara pepohonan.', height: '70 cm', weight: '12 kg' },
  { id: 'serigala_bintang', name: 'Serigala Bintang', emoji: '🌟', rarity: 'legendaris', desc: 'Binatang penjaga langit yang membawa aura cahaya di ekornya.', height: '1 m', weight: '70 kg' },
  { id: 'naga_mahligai', name: 'Naga Mahligai', emoji: '🐉', rarity: 'legendaris', desc: 'Naga emas yang menyimpan jejak kuno di dalam akar-akar kuno.', height: '6 m', weight: '900 kg' },
  { id: 'rusa_cahaya', name: 'Rusa Cahaya', emoji: '🦌', rarity: 'legendaris', desc: 'Rusa berkilau yang muncul hanya saat kabut turun di hutan.', height: '1.4 m', weight: '160 kg' },
  { id: 'titan_akar', name: 'Titan Akar', emoji: '🌿', rarity: 'legendaris', desc: 'Makhluk raksasa yang lahir dari tanah subur dan akar tua.', height: '7 m', weight: '1.5 ton' },
  { id: 'unicorn_hutan', name: 'Unicorn Hutan', emoji: '🦄', rarity: 'rahasia', desc: 'Kuda ajaib yang menunggu di padang bunga tersembunyi di pusat hutan.', height: '1.6 m', weight: '350 kg' },
  { id: 'phoenix_rimba', name: 'Phoenix Rimba', emoji: '🔥', rarity: 'rahasia', desc: 'Burung api yang muncul dari kobaran api di bawah kanopi hutan.', height: '2 m', weight: '90 kg' },
  { id: 'serigala_bulan', name: 'Serigala Bulan', emoji: '🌙', rarity: 'rahasia', desc: 'Makhluk pemburu malam yang menyalakan jejak kabut di sekitarnya.', height: '1.2 m', weight: '85 kg' },
  { id: 'kucing_langit', name: 'Kucing Langit', emoji: '☁️', rarity: 'rahasia', desc: 'Kucing halus yang melintasi awan tipis di atas pepohonan.', height: '60 cm', weight: '8 kg' },
  { id: 'dewa_pohon', name: 'Dewa Pohon', emoji: '🌲', rarity: 'rahasia', desc: 'Makhluk sakral yang menjaga hutan dari gangguan dunia luar.', height: '3.5 m', weight: '600 kg' },
  { id: 'naga_teratai', name: 'Naga Teratai', emoji: '🪷', rarity: 'rahasia', desc: 'Naga bercahaya yang bersemayam di kolam suci di dalam hutan.', height: '5 m', weight: '700 kg' }
];
